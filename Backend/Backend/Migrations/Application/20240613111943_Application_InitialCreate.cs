    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        (
            ...
            table => new
            {
                ...
                FullName = table.Column<string>
                    ("nvarchar(100)", maxLength: 100, nullable: false),
                Subdivision = table.Column<string>
            ...
            constraints: table =>
            {
                ...
                table.ForeignKey
                (
                    "FK_Employees_Employees_PeoplePartnerId",
                    x => x.PeoplePartnerId,
                    "Employees",
                    "Id",
        ...
        (
            ...
            table => new
            {
                ...
                AbsenceReason = table.Column<string>
                    ("nvarchar(max)", nullable: false),
                StartDate = table.Column<DateTime>
                    ("datetime2", nullable: false),
                EndDate = table.Column<DateTime>("datetime2", nullable: false),
                Comment = table.Column<string>
                    ("nvarchar(500)", maxLength: 500, nullable: false),
                Status = table.Column<string>
                    ("nvarchar(max)", nullable: false, defaultValue: "New")
            },
            constraints: table =>
            {
                ...
                table.ForeignKey
                (
                    "FK_LeaveRequests_Employees_EmployeeId",
                    x => x.EmployeeId,
                    "Employees",
                    "Id",
                    onDelete: ReferentialAction.Restrict
        ...
        (
            ...
            table => new
            {
                Id = table.Column<int>("int", nullable: false)
                    .Annotation("SqlServer:Identity", "1, 1"),
                ProjectType = table.Column<string>
                    ("nvarchar(max)", nullable: false),
                StartDate = table.Column<DateTime>
                    ("datetime2", nullable: false),
            ...
            constraints: table =>
            {
                ...
                table.ForeignKey
                (
                    "FK_Project_ProjectManager",
                    x => x.ProjectManagerId,
                    "Employees",
                    "Id",
                    onDelete: ReferentialAction.Restrict
                );
        ...
        (
            ...
            constraints: table =>
            {
                ...
                table.ForeignKey
                (
                    "FK_ApprovalRequests_Employees_ApproverId",
                    x => x.ApproverId,
                    "Employees",
                    "Id",
                    onDelete: ReferentialAction.Restrict
                ...
                table.ForeignKey
                (
                    "FK_ApprovalRequests_LeaveRequests_LeaveRequestId",
                    x => x.LeaveRequestId,
                    "LeaveRequests",
                    "Id",
                    onDelete: ReferentialAction.Restrict
        ...
        (
            "IX_ApprovalRequests_ApproverId",
            "ApprovalRequests",
            "ApproverId"
        );
        ...
        migrationBuilder.CreateIndex
        (
            "IX_ApprovalRequests_LeaveRequestId",
            "ApprovalRequests",
            "LeaveRequestId"
        );
        
        migrationBuilder.CreateIndex
            ("IX_Employees_PeoplePartnerId", "Employees", "PeoplePartnerId");
        
        migrationBuilder.CreateIndex
            ("IX_LeaveRequests_EmployeeId", "LeaveRequests", "EmployeeId");
        
        migrationBuilder.CreateIndex
            ("IX_Projects_ProjectManagerId", "Projects", "ProjectManagerId");
    }
